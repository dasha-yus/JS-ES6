...
export var Timeout = class Timeout extends Error {}
...
export function findRoute(from, to, connections) {
...
export function findInStorage(nest, name) {
...
export function findInRemoteStorage(nest, name) {
...
export var Group = class Group {
  constructor() { this.members = []; }
  add(m) { this.members.add(m); }
}

export function anyStorage(nest, source, name) {
  if (source == nest.name) return storage(nest, name);
  else return routeRequest(nest, source, "storage", name);
}

export async function chicks(nest, year) {
  let list = "";
