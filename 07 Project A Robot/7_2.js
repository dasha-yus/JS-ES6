...
function smartRobot({place, parcels}, route) {
  if (route.length == 0) {
    ...
    route = routes.reduce((a, b) => priority(a) > priority(b) ? a : b).route;
  }
...
function compareRobots(robot1, memory1, robot2, memory2) {
  ...
  if(total1 < total2) {
    console.log(`The goalOrientedRobot is more effective - ${total1 / numOfTasks}`);
  } else {
    console.log(`The smartRobot is more effective - ${total2 / numOfTasks}`);
  }
}
